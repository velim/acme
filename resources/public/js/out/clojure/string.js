...
{{
var G__10670 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10670;
continue;
}
} else
...
{var pred__10674 = cljs.core._EQ_;var expr__10675 = limit;if(cljs.core.truth_(pred__10674.call(null,1,expr__10675)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10674.call(null,2,expr__10675)))
...
var G__10677 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10678 = (limit__$1 - 1);
var G__10679 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10677;
limit__$1 = G__10678;
parts = G__10679;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10681 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10681))
{var replacement_10682 = temp__4090__auto___10681;buffer.append([cljs.core.str(replacement_10682)].join(''));
} else
{buffer.append(ch);
}
{
