...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13538 = 0;while(true){
var m_13539 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13539 == null))
{} else
{m_13539.call(null);
if((count_13538 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13540 = (count_13538 + 1);
count_13538 = G__13540;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3382__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3382__auto__)
