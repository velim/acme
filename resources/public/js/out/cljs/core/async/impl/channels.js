...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13544 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13544 = (function (val,box,meta13545){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13544.cljs$lang$type = true;
cljs.core.async.impl.channels.t13544.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13544";
cljs.core.async.impl.channels.t13544.cljs$lang$ctorPrWriter = (function (this__3956__auto__,writer__3957__auto__,opt__3958__auto__){return cljs.core._write.call(null,writer__3957__auto__,"cljs.core.async.impl.channels/t13544");
});
cljs.core.async.impl.channels.t13544.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13544.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13546){var self__ = this;
var _13546__$1 = this;return self__.meta13545;
});
cljs.core.async.impl.channels.t13544.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13546,meta13545__$1){var self__ = this;
var _13546__$1 = this;return (new cljs.core.async.impl.channels.t13544(self__.val,self__.box,meta13545__$1));
});
cljs.core.async.impl.channels.__GT_t13544 = (function __GT_t13544(val__$1,box__$1,meta13545){return (new cljs.core.async.impl.channels.t13544(val__$1,box__$1,meta13545));
});
}
return (new cljs.core.async.impl.channels.t13544(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3959__auto__,writer__3960__auto__,opts__3961__auto__){return cljs.core._write.call(null,writer__3960__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3956__auto__,writer__3957__auto__,opt__3958__auto__){return cljs.core._write.call(null,writer__3957__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13547 = self__.takes.pop();if((taker_13547 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13547))
{var take_cb_13548 = cljs.core.async.impl.protocols.commit.call(null,taker_13547);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13548,taker_13547){
return (function (){return take_cb_13548.call(null,null);
});})(take_cb_13548,taker_13547))
);
} else
{}
{
